            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text('نەخشەی راستەوخۆ', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2C))),
                    ElevatedButton.icon(
                      style: ElevatedButton.styleFrom(backgroundColor: Colors.orange, foregroundColor: Colors.white),
                      onPressed: _isEditingLocation ? null : _showRestaurantPicker,
                      icon: const Icon(Icons.add_location_alt),
                      label: const Text('دیاریکردنی شوێنی خوارنگەهـ'),
                    ),
                  ],
                ),
